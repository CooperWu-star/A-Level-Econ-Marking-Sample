---
name: cie-econ-essay
description: Marks and writes CIE A-Level Economics (9708) essay and data-response answers — AS Paper 2 and A-Level Paper 4, including the 8-mark and 12-mark essay parts and structured data-response questions. Applies official CIE level descriptors (L1–L4) and AO1–AO4 commentary, and produces A*-grade sample answers with plan, full essay (with diagram descriptions), and examiner notes. Use this skill whenever the user pastes an Economics essay or data-response answer, asks for it to be marked, asks for a model/sample/A* answer to a CIE Economics question, mentions Paper 2 or Paper 4, mark scheme bands, AO1/AO2/AO3/AO4, evaluation, or just shares an Economics question and asks "how would you answer this" — even if they don't explicitly say "CIE" or "A-Level".
---
